...
import responsitory.TaiKhoanResponsitory;
...
public class Login extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/logoKinh.png"))); // NOI18N
    ...
    private int check;
    private TaiKhoanResponsitory taiKhoanResponsitory = new TaiKhoanResponsitory();
    ...
    private void Login() throws SQLException {
        ...
        List<TaiKhoan> list = taiKhoanResponsitory.getAll();
        
        for(TaiKhoan i : list){
            if(ma.toLowerCase().equals(i.getTaiKhoan().trim().toLowerCase()) && pass.toLowerCase().equals(i.getMatKhau().trim().toLowerCase())){
               new FrameMain().setVisible(true);
               this.setVisible(false);
               return;
            }
        }
        JOptionPane.showMessageDialog(this, "Tài khoản mật khẩu không chính xác", "Lỗi", JOptionPane.ERROR_MESSAGE);
    }
