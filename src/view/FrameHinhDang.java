...
import responsitory.HinhDangResponsitory;
/**
 *
 * @author GIGABYTE
 */
public class FrameHinhDang extends javax.swing.JFrame {
    private HinhDangResponsitory service = new HinhDangResponsitory();
    private DefaultTableModel dtm = new DefaultTableModel();
    private int index = 0;
    /**
     * Creates new form HinhDangFrame
     */
    public FrameHinhDang() {
        initComponents();
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (this.txtLoai.getText().isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameHinhDang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
